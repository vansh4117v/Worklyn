...
import { sendEmailVerificationCode, verifyEmail } from "@/api/apiAuth";
...
export default function EmailVerificationPage() {
  ...
  // Redirect on successful verification and set user in context
  useEffect(() => {
  ...
  }, [verifyData, verifyError, navigate, setUser]);
